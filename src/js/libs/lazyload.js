...
;(function(factory){
    ...
    var w = window,
        ...
        isMobile = (/applewebkit.*mobile.*/g).test(navigator.userAgent.toLocaleLowerCase()),
        type // function
            ...
            $elements.each(function(i,e){
                ...
                $element.one('_lazyload_appear',function(){
                    ...
                    function loadFunc(){
                        ...
                        // Hide this element may cause styles reflow, call it as less as possible
